...
function computeZoneGaps(
  ...
  const zonaDesfavorecida =
    comparison === 'rural_urbano' ? 'rural' : 'periurbano'
  ...
  const years = [...new Set([...desfByYear.keys(), ...favByYear.keys()])].sort(
    (a, b) => a - b,
  )
        ...
        <div className="flex items-center justify-between gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={() =>
                downloadCsvBA(gapsData, `brecha-absoluta-${comparison}`)
              }
              ...
              <thead className="bg-gray-50 text-gray-600 uppercase text-xs">
                <tr>
                  ...
                  <th className="px-4 py-3 font-medium">
                    RMM{' '}
                    {zonaDesfavorecida.charAt(0).toUpperCase() +
                      zonaDesfavorecida.slice(1)}
                  </th>
                  <th className="px-4 py-3 font-medium">
                    RMM{' '}
                    {zonaFavorecida.charAt(0).toUpperCase() +
                      zonaFavorecida.slice(1)}
                  </th>
                ...
                {gapsData.map((row) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-gray-600">
                      {row.rmm_desfavorecido.toFixed(1)}
                    </td>
                    <td className="px-4 py-3 text-gray-600">
                      {row.rmm_favorecido.toFixed(1)}
                    </td>
                    <td className="px-4 py-3 text-gray-600">
        ...
        <div className="flex items-center justify-between gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={() =>
                downloadCsvBR(gapsData, `brecha-relativa-${comparison}`)
              }
              className="flex items-center gap-1.5 px-4 py-1.5 text-sm rounded-lg border border-gray-200 bg-white text-gray-600 hover:bg-gray-50 transition-colors"
            >
              <Icon icon="mdi:download" className="size-4 opacity-50" />
